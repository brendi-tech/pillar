/**
 * SVG Icons for SDK Preview Components
 * These icons match the ones used in the SDK for visual consistency.
 */

import React from 'react';

// Send icon (arrow pointing right/up)
...
// Arrow right icon (for question chips)
