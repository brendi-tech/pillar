...
const liveDemos: LiveDemo[] = [
  {
    ...
    name: "Superset",
    description:
      "AI copilot for Apache Superset dashboards and data exploration.",
  ...
  },
  {
    ...
    name: "Grafana",
    description:
      "AI copilot for Grafana monitoring, queries, and alert management.",
            ...
            <>
              ...
              <div className="flex items-center justify-between px-4 py-3">
                <div className="flex items-center gap-2">
                  <span
                    className={`font-mono text-xs md:text-sm font-semibold tracking-wider uppercase ${demo.comingSoon ? "text-[#1A1A1A]/50" : "text-[#1A1A1A]"}`}
                  >
                    {demo.name}
                  </span>
                  {demo.comingSoon && (
