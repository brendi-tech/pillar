...
// Scene timing constants - aligned with Analytics UI transitions
...
// Step timing - synced with Analytics UI changes (4 steps with activeText/completeText)
const STEP_TIMING = [
  { start: 204, complete: 265 },  // Step 1: Listing data sets → Found 47
  { start: 275, complete: 340 },  // Step 2: Writing SQL → Query ready
  { start: 350, complete: 405 },  // Step 3: Executing → 12 rows
  { start: 410, complete: 435 },  // Step 4: Saving → Added to dashboard
];

// Response timing
const RESPONSE_START = 435;
...
export const CoPilotPanel = ({
  ...
  return (
    ...
    >
      ...
      >
        ...
        {isMessageSent && (
          ...
          >
            ...
            {/* Steps indicator area - Technical MCP flow */}
            {visibleStepCount > 0 && (
              <div
                style={{
                  display: "flex",
      ...
      {/* Input Field - Blue focus for analytics */}
      <div
        style={{
      ...
      >
        <div
          style={{
            ...
            borderRadius: 15,
            border: `${showInputFocus ? "2px" : "0.8px"} solid ${showInputFocus ? "#3B82F6" : "#E4E0D9"}`,
            padding: "18px 24px",
            gap: 18,
            boxShadow: showInputFocus
              ? `0 0 0 ${4 * focusGlowOpacity}px rgba(59, 130, 246, ${0.15 * focusGlowOpacity})`
              : "none",
          }}
        >
          <div
          ...
          <div
            style={{
              ...
              height: 48,
              borderRadius: 12,
              backgroundColor: isSpinning ? "#22C55E" : "#22C55E",
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
