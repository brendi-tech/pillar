    ...
    <form onSubmit={handleSubmit} className="flex flex-col items-center">
      <div className="flex flex-wrap items-center justify-center gap-2.5">
        ...
        <Input
          ...
          className="h-8 text-base bg-white border-[#D4D4D4] placeholder:text-[#999] focus-visible:ring-[#FF6E00]/30 focus-visible:border-[#FF6E00] max-w-[220px]"
        />
        <Button
          type="submit"
          disabled={subscribe.isPending}
      ...
      {error && (
        <p className="mt-1.5 text-xs text-[#FF4E42] font-medium text-center">
          {error}
        </p>
      )}
    </form>
